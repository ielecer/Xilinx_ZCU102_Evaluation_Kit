...
synth_design -top runLed -part xczu9eg-ffvb1156-2-e


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef runLed.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file runLed_utilization_synth.rpt -pb runLed_utilization_synth.pb"
